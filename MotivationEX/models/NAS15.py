...
class NAS15(nn.Module):
	...
	def forward(self, x):
                ...
                o10 =  (F.relu(self.batch10(self.cov10(co13456789))))
                co125678910 = torch.cat((o1, o2, o5, o6, o7, o8, o9, o10), 1)
                o11 =  (F.relu(self.batch11(self.cov11(co125678910))))
                ...
                o14 =  (F.relu(self.batch14(self.cov14(co371213))))
                co2711121314 = torch.cat((o2, o7, o11, o12, o13, o14), 1)
                o15 =  (F.relu(self.batch15(self.cov15(co2711121314))))
