...
class NAS15_cut(nn.Module):
	def __init__(self):
		super(NAS15_cut, self).__init__()
		...
		self.cov10 = Conv2d(324-36,36,(7,7))
		self.batch10 = nn.BatchNorm2d(36)
		self.cov11 = nn.Conv2d(336-48,36,(5,7),1,(2,3))
		...
		self.cov14 = nn.Conv2d(180-36-48,48,(7,5),1,(3,2))
		self.batch14 = nn.BatchNorm2d(48)
		self.cov15 = nn.Conv2d(276-48-48,48,(7,5),1,(3,2))
	...
	def forward(self, x):
                o1 =  (F.relu(self.batch1(self.cov1(x))))
                o2 =  (F.relu(self.batch2(self.cov2(o1))))
                co12 = torch.cat((o1, o2), 1)
                o3 =  (F.relu(self.batch3(self.cov3(co12))))
                co123 = torch.cat((o1, o2, o3), 1)
                o4 =  (F.relu(self.batch4(self.cov4(co123))))
                co34 = torch.cat((o3, o4), 1)
                o5 =  (F.relu(self.batch5(self.cov5(co34))))
                co2345 = torch.cat((o2, o3, o4, o5), 1)
                o6 =  (F.relu(self.batch6(self.cov6(co2345))))
                co23456 = torch.cat((o2, o3, o4, o5, o6), 1)
                o7 =  (F.relu(self.batch7(self.cov7(co23456))))
                co167 = torch.cat((o1, o6, o7), 1)
                o8 =  (F.relu(self.batch8(self.cov8(co167))))
                co1658 = torch.cat((o1, o6, o5, o8), 1)
                o9 =  (F.relu(self.batch9(self.cov9(co1658))))
                co1456789 = torch.cat((o1, o4, o5, o6, o7, o8, o9), 1)
                o10 =  (F.relu(self.batch10(self.cov10(co1456789))))
                co15678910 = torch.cat((o1, o5, o6, o7, o8, o9, o10), 1)
                o11 =  (F.relu(self.batch11(self.cov11(co15678910))))
                co1234611 = torch.cat((o1, o2, o3, o4, o6, o11), 1)
                o12 =  (F.relu(self.batch12(self.cov12(co1234611))))
                co136789101112 = torch.cat((o1, o3, o6, o7, o8, o9, o10, o11, o12), 1)
                o13 =  (F.relu(self.batch13(self.cov13(co136789101112))))
                co1213 = torch.cat((o12, o13), 1)
                o14 =  (F.relu(self.batch14(self.cov14(co1213))))
                co11121314 = torch.cat((o11, o12, o13, o14), 1)
                o15 =  (F.relu(self.batch15(self.cov15(co11121314))))
